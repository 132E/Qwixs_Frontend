...
const EditBusiness = () => {
    ...
    const handleSubmitBusiness = async (event) => {
        ...
        await axios.put(`${BASE_URL}/businesses/${business.id}`,businessFormState);
        setBusinessFormState(initialStateBusiness);
        navigate(`/owner/${business.ownerId}`);
    }


    return (
        <div className="main-container">
            <h1>Edit Business</h1><div className="form-container">
                    <form onSubmit={handleSubmitBusiness}>
                        ...
                        <input
                            ...
                            type="text"
                            onChange={handleChangeBusiness}
                            value={businessFormState.address}
                            placeholder="Adress"
                        />
                        <input
                            id="city"
